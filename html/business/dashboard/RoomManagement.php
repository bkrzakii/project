...
<head>
    ...
    <title>Room Managment - BookingDZ</title>
        ...
        <main class="main">
            <div class="sidebar">
                <ul>
                    ...
                    <li><a href="#" class="active" >Room Management</a></li>
                    <li><a href="../../business/dashboard/BookingsOverview.php">Bookings Overview</a></li>
                    <li><a href="../../business/dashboard/Messages&Feedback.php">Messages & Feedback</a></li>
                </ul>
            </div>
        <div class="container">
...
<script src="../../../js/business/dashboard/RoomManagement.js" defer></script>
</body>
</html>