...
=======
            ...
            ?>
>>>>>>> 6ab858e9d3d73095da1d0738463fdb8b087b2866
        </div>
        <div class="content">
            <div class="content-header">
                <div class="order">
                    <?php
                    $sql = "SELECT COUNT(*) as total FROM booking WHERE booking_id = $hotelId";
                    $result = $conn->query($sql);
                ...
                <div class="Revenue">
                    ...
                    <?php 
                    $sql = "SELECT SUM(total_price) as total FROM booking WHERE booking_id = $hotelId";
                    $result = $conn->query($sql);
                    if ($result->num_rows > 0) {
                        $row = $result->fetch_assoc();
